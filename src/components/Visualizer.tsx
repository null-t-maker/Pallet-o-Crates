  ...
  return (
    <div ref={runtime.cameraState.containerRef} style={{ width: "100%", height: "100%", position: "relative" }}>
      ...
      <VisualizerOverlays
        ...
        manualShadowModeEnabled={runtime.manualShadowModeEnabled}
        handleManualRotate={runtime.manualEditing.handleManualRotate}
        handleManualShadowModeChange={runtime.manualEditing.handleManualShadowModeChange}
        handleManualAlignToSupportEdgeX={runtime.manualEditing.handleManualAlignToSupportEdgeX}
        handleManualAlignToSupportEdgeY={runtime.manualEditing.handleManualAlignToSupportEdgeY}
        handleManualAxisInput={runtime.manualEditing.handleManualAxisInput}
        handleManualAxisPatchInput={runtime.manualEditing.handleManualAxisPatchInput}
        result={props.result}
        ...
        manualShadowModeLabel={runtime.sceneState.manualShadowModeLabel}
        manualShadowModeOnLabel={runtime.sceneState.manualShadowModeOnLabel}
        manualShadowModeOffLabel={runtime.sceneState.manualShadowModeOffLabel}
        manualAlignSectionLabel={runtime.sceneState.manualAlignSectionLabel}
        manualAlignXButtonLabel={runtime.sceneState.manualAlignXButtonLabel}
        manualAlignYButtonLabel={runtime.sceneState.manualAlignYButtonLabel}
        manualAxisInputModeLabel={runtime.sceneState.manualAxisInputModeLabel}
        manualAxisInputAutoLabel={runtime.sceneState.manualAxisInputAutoLabel}
        manualAxisInputManualLabel={runtime.sceneState.manualAxisInputManualLabel}
        manualAxisApplyLabel={runtime.sceneState.manualAxisApplyLabel}
